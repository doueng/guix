...
This finalizer currently supports Git repositories only. In a Jujutsu repository, stop and report that finalization must be performed with a JJ-specific workflow; do not invoke Git through the shell or run `finalize.sh`.
