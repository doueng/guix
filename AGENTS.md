...
- Author Scheme in `modules/` and desktop assets in `desktop/`. `desktop/configs/` contains the formerly shared configs (independently maintained) and machine-specific Hypr configs.
